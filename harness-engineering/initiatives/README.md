...
| [2026-06-1.1.3-species-score-and-admob](2026-06-1.1.3-species-score-and-admob.md) | 1.1.3 要件: 魚種ごと釣れる度(¥300サブスク・既存tsurilog_lite流用)＋AdMob改善(NPA/同意/ATT・インタースティシャル) | 🟡 要件定義 |
