...
| 4 | 環境データ取得が **WWO 1 本依存**(潮汐・気象・波高・水温すべて) | 障害時に分析が劣化 / 海象が粗い疑い | キャッシュ(env_cache / mesh)前提を壊さない。AI戦略では波高/海象ソースを PoC で見直し(`assessment/external-apis-ai-strategy.md`)+ 地形は海しる導入 |
